document.querySelector('.btn').addEventListener('click', () => {
    ...
    document.getElementById('hex-code').innerHTML = hexcode;    document.getElementsByTagName('body')[0].style.background = '#' + hexcode;
});
...
//     for(let i=0; i < 6; i++) {
//         random_index = Math.floor(Math.random() * hex_numbers.length);hexcode1 += hex_numbers[random_index];
